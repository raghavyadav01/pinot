...
public class LuceneTextIndexBufferIntegrationTest {
  ...
  public void setUp() throws IOException {
    ...
    _combinedFile = new File(_tempDir, COLUMN_NAME + ".lucene.index");
  ...
  private void createLuceneIndexFiles() throws Exception {
    ...
    try (LuceneTextIndexCreator creator = new LuceneTextIndexCreator(COLUMN_NAME, _tempDir, true, false, null,
        null, textIndexConfig)) {
