 ...
 */
public class LuceneTextIndexBackwardCompatibilityTest {
  private static final Logger LOGGER = LoggerFactory.getLogger(LuceneTextIndexBackwardCompatibilityTest.class);
